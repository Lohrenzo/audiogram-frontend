...
export default async function Home() {
  return (
    <main className="place-items-center grid h-screen w-screen overflow-x-hidden">
      <div className="grid grid-cols-1 place-items-center w-[80vw] text-center p-2">
        <h1 className="mb-2 font-bold text-lg">Hello and Welcome</h1>
        <p className="font-bold mb-7 leading-snug tracking-wider font-sans uppercase md:text-3xl text-2xl">
